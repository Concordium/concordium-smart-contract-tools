...
import { BROWSER_WALLET, INPUT_PARAMETER_TYPES_OPTIONS, REFRESH_INTERVAL } from './constants';
                            ...
                            <Box header="Step 2: Initialize Smart Contract">
                                <Form>
                                        ...
                                        <Form.Check
                                            ...
                                            onChange={async (e) => {
                                                ...
                                                const checkboxElement =
                                                    initForm.getValues('useModuleReferenceFromStep1');
                                        ...
                                        <>
                                            ...
                                            <Alert variant="info">
                                                ...
                                                <div>
                                                    ...
                                                    <code>module reference</code>, the <code>smart contract name</code>,
                                                    or an <code>input parameter schema</code>.
                                                </div>
                                                <br />
                                                <div>
                                                    <b>Uncheck</b> and <b>check</b> this box again, if you want to load
                                                    a new module from step 1.
                                                </div>
                                            </Alert>
                                            <br />
                                        </>
                                    ...
                                    {moduleReferenceError && (
                                        <Alert variant="danger"> Error: {moduleReferenceError}. </Alert>
                                    )}
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (moduleRef !== undefined && moduleRef.length !== 64) {
                                                        setModuleReferenceLengthError(
                                                            'Module reference has to be of length 64'
                                                        );
                                                    }
                                                }}
                                            />
                                    ...
                                    {moduleReferenceLengthError && (
                                        <Alert variant="danger"> Error: {moduleReferenceLengthError}. </Alert>
                                    )}
                                    ...
                                    {isPayable && (
                                        <Form.Group className=" mb-3">
                                            ...
                                            />
                                            <Form.Text />
                                            {initForm.formState.errors.cCDAmount && (
                                    ...
                                    {hasInputParameter && (
                                        <div className="box">
                                            ...
                                            {uploadError2 !== undefined && (
                                                <Alert variant="danger"> Error: {uploadError2}. </Alert>
                                            )}
                                            ...
                                            {(inputParameterType === 'number' || inputParameterType === 'string') && (
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        placeholder={
                                                            inputParameterType === 'string' ? 'myString' : '1000000'
                                                        }
                                            ...
                                            {parsingErrorInit !== undefined && (
                                                <Alert variant="danger"> Error: {parsingErrorInit}. </Alert>
                                            )}
                                        </div>
                                    )}
                                    <br />
                                    ...
                                    {!txHashInit && transactionErrorInit && (
                                        <Alert variant="danger">Error: {transactionErrorInit}.</Alert>
                                    )}
                                    {txHashInit && (
                                        <>
                                            <div>
                                            ...
                                            <br />
                                            <div>
                                                CCDScan will take a moment to pick up the above transaction, hence the
                                                above link will work in a bit.
                                            </div>
                                            <div>
